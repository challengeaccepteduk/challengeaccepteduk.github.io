...
const PartnerWithUs = () => {
  return (
    <Content>
      ...
      <h2>Coming soon - marketing campaigns on Challenge Accepted</h2>
      <p>We can work with you to create an engaging branded challenge on the app that's focused on your customers having fun and taking on a challenge for something you are both passionate about.
      ...
      <br/><br/> To find out more about branded challenges and to discuss how we can support your marketing campaign, please <a href="/contact-us">get in touch.</a></p>
      <h2>Supporting UK charities</h2>
      <p>Since the launch of Challenge Accepted in July last year, we've had over 2,000 people participate in virtual fundraising challenges on the app from UK charities including:</p>
