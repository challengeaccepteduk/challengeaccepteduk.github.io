...
const PartnerAppFeatures = () => {
  ...
  return (
      <Container fluid className="partner-features-container">
        <Row>
          <Col>
            <p className="partner-feature-header">We will work with you to ensure your brand
             is reaching the right audience based on showing an active interest and passion for your product
             or industry and therefore help achieve your brand objective of brand awareness, engagement or traffic.</p>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col>
            <p className="partner-feature-text">
              <b>Demand Generation</b><br/>Providing offers to our base of customers that show an interest in your product</p>
          </Col>
          <Col>
            <p className="partner-feature-text">
              <b>Brand awareness and credibility</b><br/>Sponsoring challenges or categories</p>
          </Col>
          <Col>
            <p className="partner-feature-text">
              <b>Brand awareness and engagement</b><br/>Working together to create a challenge relevant for your brand</p>
          </Col>
          <Col md={2}>
          </Col>
        </Row>
        ...
        <Row>
          <Col>
            <p className="partner-feature-footer"><b>To find out more about opportunities at launch,<br/>contact us using the form below.</b></p>
          </Col>
        </Row>
        <Row>
          <Col md={2}></Col>
          ...
          <Form name="contact" noValidate validated={validated}
            ...
            <Form.Group controlId="formGridMessage">
              <Form.Control as="textarea" ref={messageRef} rows="4" placeholder="Message"/>
            </Form.Group>
            <Form.Row>
