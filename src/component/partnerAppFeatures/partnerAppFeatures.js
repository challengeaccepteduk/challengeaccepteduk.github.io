...
const PartnerAppFeatures = () => {
  ...
  return (
      <Container fluid className="partner-features-container">
        <Row>
          <Col>
            <p className="partner-feature-header">We will work with you to ensure your brand is reaching<br/>
            the right audience and achieve your brand objective of<br/>either awareness, engagement or traffic.</p>
          </Col>
        </Row>
